            ...
            <Flex vertical justify="center" align="center" style={{ height: '100vh' }}>
                ...
                <Card title="Bảng điều khiển" style={{ width: '100%', maxWidth: 800 }}>
                    <Space style={{ overflowX: 'auto', width: '100%', padding: 10 }} >
                        ...
                        <Button type="primary" style={{ backgroundColor: '#eb2f96', borderColor: '#eb2f96' }} onClick={() => navigate('/test-drag-and-drop')}>/test-drag-and-drop</Button>
                        <Button type="primary" style={{ backgroundColor: '#eb2f96', borderColor: '#eb2f96' }} onClick={() => navigate('/test-video')}>/test-video</Button>
                    </Space>
                </Card>
                {/* float button */}
                <FloatButton
